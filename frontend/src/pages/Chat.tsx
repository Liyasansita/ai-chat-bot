    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography
            sx={{ textAlign: "center", fontWeight: 600, mb: 2, color: "#000" }}
          >
            You are talking to Lexi AI
          </Typography>
          <Typography
          ...
          >
            ...
            etc. Avoid sharing personal info.
          </Typography>
          <Button
            onClick={handleDeleteChats}
            sx={{
      ...
      >
        <Typography
          sx={{
            ...
            textAlign: "center",
            mb: 2,
            color: "#f5f5dc", // Beige title on black
          }}
        >
          Model - Gemini
        </Typography>
        ...
        <Box
          sx={{
            ...
            mb: 2,
            bgcolor: "#000000",
            boxShadow: "0 8px 30px rgba(245,245,220,0.2)",
          }}
        >
          {chatMessages.map((chat, index) => (
            <ChatItem content={chat.content} role={chat.role} key={index} />
        ...
        <Box
          sx={{
            ...
            px: 2,
            py: 1,
            boxShadow: "0 4px 20px rgba(245,245,220,0.2)",
            alignItems: "center",
            gap: 1,
          }}
        >
